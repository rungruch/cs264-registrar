            ...
            if(searchid == studentclass[li].advisor && studentclass[li].teacheradvisorcheck == false &&searchid == studentclass[li].subprofname && studentclass[li].teachersubjectcheck == false ){
              //  alert(1);
               ...
               cell2.innerHTML = studentclass[li].studentFirstName ;
                ...
                cell4.innerHTML = '<a href="/formapprove?studentid='+studentclass[li].studentId+'&subject='+studentclass[li].subid+'&role=advisor+subject_teacher'+'" class="button">button &raquo;</a>';
                tablecnt = tablecnt+1;
               ...
               cell1.innerHTML = studentclass[li].subname;
               cell2.innerHTML = studentclass[li].studentFirstName;
                cell3.innerHTML = "subject_teacher";
                cell4.innerHTML = '<a href="/formapprove?studentid='+studentclass[li].studentId+'&subject='+studentclass[li].subid+'&role=subject_teacher'+'" class="button">button &raquo;</a>';
                tablecnt = tablecnt+1;
             }
         ...
         for (let li  = 0 ; li<count ;li++){
           ...
           if(true == studentclass[li].teacheradvisorapprove && studentclass[li].authorapprove == true && studentclass[li].teachersubjectapprove == true){
             //  alert(1);
              ...
              cell2.innerHTML = studentclass[li].studentFirstName ;
               cell3.innerHTML = "advisor+subject_teacher";
               cell4.innerHTML = '<a href="/printform?studentid='+studentclass[li].studentId+'&subject='+studentclass[li].subid+'" class="button">button &raquo;</a>';
               tablecnt = tablecnt+1;
